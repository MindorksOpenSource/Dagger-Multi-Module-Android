...
* **When should you use a fragment rather than an activity?**
    ...
    - when you want your data to be there across activity
...
* **How would you perform a long-running operation in an application?** - [Learn from here](https://www.developer.com/ws/android/programming/executing-long-running-background-tasks-in-android-apps-without-an-interface-using-services.html)
...
* **What is ORM? How does it work?** - [Learn from here](https://blog.mindorks.com/powerful-android-orm-greendao-3-tutorial)
...
* **What is commit() and apply() in SharedPreferences?**
    - commit() returns a boolean value pf success or failure by writing data synchronously immediately.
    - apply() is asynchronous and it won't return any boolean response. If you have an apply() outstanding and then you perform commit(), then the commit() will be blocked until the apply() is not completed.
...
* **How to change some parameter in an app without app update?** - [Learn from here](https://blog.mindorks.com/getting-started-with-firebase-remote-config-in-android)
...
* **How does the Dagger work?** - [Learn from here](https://blog.mindorks.com/android-annotation-processing-tutorial-part-1-a-practical-approach)
...
* **Describe the repository pattern** - [Learn from here](https://proandroiddev.com/the-real-repository-pattern-in-android-efba8662b754)
...
* **Recursion and Divide & Conquer Approach** - [Learn from here](https://afteracademy.com/tech-interview/ds-algo-concepts/recursion-and-divide-and-conquer-approach)
    ...
    - Explain the Divide and Conquer technique with the help if a real-world example.
...
* **Arrays and Linked List** - [Learn from here](https://afteracademy.com/tech-interview/ds-algo-concepts/array-and-linked-list)
    ...
    - What are the type of Linked List?
